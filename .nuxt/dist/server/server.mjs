...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-0de908aa><p class="chat__alias" data-v-0de908aa>${ssrInterpolate(__props.chat.alias)}</p><p class="chat__amount" data-v-0de908aa><span class="chat__amount--text" data-v-0de908aa>${ssrInterpolate(__props.chat.amount)}</span><span class="chat__amount--sybl" data-v-0de908aa> JPYC</span></p><p class="chat__message" data-v-0de908aa>${ssrInterpolate(__props.chat.message)}</p></div>`);
    };
  }
};
